...
export function InteractiveStar({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center justify-center p-1 rounded-full cursor-pointer focus:outline-none transition-transform duration-500 ease-in-out hover:scale-110 active:scale-95 origin-center",
